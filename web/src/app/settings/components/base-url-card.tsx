        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-white/40">设置 `CHATGPT2API_BASE_URL` 的本地配置值，保存后立即生效。</p>
            </div>
          </div>
        ...
        {isLoadingConfig ? (
          ...
          <>
            <div className="space-y-2">
              <label className="text-sm font-medium text-white/60">Base URL</label>
              <Input
                value={baseUrl}
              ...
              />
              <p className="text-sm text-white/35">留空则使用环境变量或默认值，保存时会自动去掉首尾空格。</p>
            </div>
